...
for (let i = 1; i <= topRated; i++) {
    ...
    topRatedCon.innerHTML = `
<div class="row top-rated-container">
    <div class="col-12 col-lg-6 left-col">
        <h2 id="top-places">Top Rated Places</h2>
        <div class="row top-rated-places" id="top-rated-place1-${i}">
            <img id="place-img1-${i}" src="" class="col-12 col-lg-4 col-md-4 place-image">
            <div class="col-12 col-lg-8 col-md-8 place-info">
        ...
        <div class="row top-rated-places" id="top-rated-place2-${i}">
            <img id="place-img2-${i}" src="" class="col-12 col-lg-4 col-md-4 place-image">
            <div class="col-12 col-lg-8 col-md-8 place-info">
        ...
        <div class="row top-rated-places" id="top-rated-place3-${i}">
            <img id="place-img3-${i}" src="" class="col-12 col-lg-4 col-md-4 place-image">
            <div class="col-12 col-lg-8 col-md-8 place-info">
    ...
    <div class="col-12 col-lg-6 right-col">
        ...
        <div class="row top-rated-foods" id="top-rated-food1-${i}">
            <img id="food-img1-${i}" src="" class="col-12 col-lg-4 col-md-4 food-image">
            <div class="col-12 col-lg-8 col-md-8 food-info">
        ...
        <div class="row top-rated-foods" id="top-rated-food2-${i}">
            <img id="food-img2-${i}" src="" class="col-12 col-lg-4 col-md-4 food-image" >
            <div class="col-12 col-lg-8 col-md-8 food-info">
        ...
        <div class="row top-rated-foods" id="top-rated-food3-${i}">
            <img id="food-img3-${i}" src="" class="col-12 col-lg-4 col-md-4 food-image" >
            <div class="col-12 col-lg-8 col-md-8 food-info">
...
//A contructor function that defines the the image that will be used, the Name of the place,
//the description of the place and a place holder for the URL
...
//Creating the constructor object with a string that is linked to the HTML
//The description of the location and image (screenshot), was taken from
//https://www.lonelyplanet.com/lebanon/beirut/attractions/national-museum-of-beirut/a/poi-sig/418869/361093
...
//The description of the location and image was taken from
//https://www.lonelyplanet.com/lebanon/beirut/attractions/maronite-cathedral-of-st-george/a/poi-sig/418885/361093
...
//The description of the location and image was taken from
//https://www.lonelyplanet.com/lebanon/beirut/attractions/pigeon-rocks/a/poi-sig/1574639/361093
...
//The description of the location and image was taken from
//https://www.lonelyplanet.com/united-arab-emirates/dubai/attractions/burj-al-arab/a/poi-sig/1146398/361166
...
//The description of the location and image was taken from
//https://www.lonelyplanet.com/united-arab-emirates/dubai/attractions/img-worlds-of-adventure/a/poi-sig/1558762/361166
...
//The description of the location and image was taken from
//https://www.lonelyplanet.com/united-arab-emirates/dubai/attractions/gold-souq/a/poi-sig/397285/361166
...
//The description of the location and image was taken from
//https://www.britannica.com/topic/Egyptian-Museum-Cairo-Egypt
...
//The description of the location and image was taken from
//https://theculturetrip.com/africa/egypt/articles/the-essential-guide-to-cairos-khan-el-khalili-market/
...
//The description of the location and image was taken from
//https://www.lonelyplanet.com/articles/best-stops-on-a-stroll-along-ammans-famous-rainbow-street
...
//https://www.lonelyplanet.com/jordan/jerash-and-the-north/irbid/attractions/jordan-natural-history-museum/a/poi-sig/1073967/361071
//For the image, i used
//https://www.planetware.com/jordan/top-rated-things-to-do-in-amman-jo-1-2.htm
...
//A constructor function that defines the image that will be used, the Name of the place,
//the description of the place and a place holder for the URL.
...
//The description of the food and image was taken from
...
//The description of the food and image was taken from
//https://food52.com/recipes/66975-shish-barak-lebanese-lamb-dumplings-in-yogurt-sauce
...
//The description of the food and image was taken from
//https://www.arabamerica.com/recipe/bayad-maa-qawarma-eggs-preserved-meat/
...
//The description of the food and image was taken from
//https://www.marthastewart.com/1514852/balaleet
...
//The description of the food and image was taken from
//http://www.clubnoor.com/en/recipe/ramadan-time/lamb-machboos
...
//The description of the food and image was taken from
//http://www.clubnoor.com/en/recipe/arabian/luqaimat
...
//The description of the food and image was taken from h
//ttps://www.bbcgoodfood.com/recipes/imam-bayildi-bbq-lamb-tzatziki
...
//The description of the food and image was taken from
//https://www.curiouscuisiniere.com/kushari/
...
//The description of the food and image was taken from
//https://www.themediterraneandish.com/hawawshi-recipe/
...
//The description of the food and image was taken from
//https://www.international-alert.org/news/mansaf
...
//The description of the food and image was taken from
//https://www.allrecipes.com/recipe/160087/upside-down-maqluba/
...
//Hiding all the content so when the country is selected from the drop down, it will keep
//the others hidden but display the country that is chosen
...
//This hides and shows the content for the selected value from the drop down option list. I used
//https://jsfiddle.net/arshadhussain/423mv/ to assist me with the creation of this code.
